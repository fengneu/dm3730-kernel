...
#include <linux/i2c/bq27xxx_battery.h>
...
#define to_bq27xxx_device_info(x) container_of((x), \
							struct bq27xxx_device_info, bat);
...
{
	int ret = 0;
	struct bq27xxx_device_info *di = to_bq27xxx_device_info(psy);
...
int bq27xxx_battery_setup(struct bq27xxx_device_info *di)
{
	...
	di->bat.num_properties = bq27xxx_battery_props[di->chip].size;
...
static struct i2c_driver bq27xxx_battery_driver = {
	.driver = {
...
static int __init bq27xxx_battery_init(void)
{
	...
	ret = i2c_add_driver(&bq27xxx_battery_driver);
	if (ret)
		printk(KERN_ERR "Unable to register BQ27xxx driver\n");
...
{
	i2c_del_driver(&bq27xxx_battery_driver);
}

module_init(bq27xxx_battery_init);
module_exit(bq27xxx_battery_exit);

MODULE_AUTHOR("Jasper Zhang<niat_zhy@163.com>");
